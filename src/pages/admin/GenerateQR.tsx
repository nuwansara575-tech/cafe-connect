    ...
    <div className="max-w-lg space-y-6">
      ...
      <Card>
        <CardContent className="pt-6 space-y-4">
          ...
          <div><Label>Campaign Name</Label><Input value={campaignName} onChange={e => setCampaignName(e.target.value)} /></div>
          ...
          <div><Label>Offer Title (optional)</Label><Input value={offerTitle} onChange={e => setOfferTitle(e.target.value)} placeholder="Auto-generated if empty" /></div>
          <div><Label>Offer Description</Label><Input value={offerDescription} onChange={e => setOfferDescription(e.target.value)} /></div>
          <div><Label>Number of Coupons</Label><Input type="number" value={count} onChange={e => setCount(Number(e.target.value))} min={1} max={500} /></div>
